...
let g:ale_cpp_clang_options = '-std=c++20 -I../binaryninja-api/ -I../3rd_party/argparse/include -I../3rd_party/plog/include -stdlib=libc++'
let g:ale_cpp_clang_executable = 'clang++-11'
